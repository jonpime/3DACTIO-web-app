...
const BusinessStrategy = () => {
    document.title = "Business Strategy | 3D ACTIO";
        ...
        <div className="page-content" style={{ paddingTop: '45px' }}>
            <Container fluid>
                ...
                <div style={{ position: 'relative', width: '100%', height: 'calc(132vh - 50px)', overflow: 'hidden' }}>
                    <iframe
                        src="https://docs.google.com/spreadsheets/d/1adAuB3RqxekvZphqqHspS0aHvKCffFSAQCm-h9wCgUs/edit?usp=sharing/pubhtml?gid=822064063&amp;single=true&amp;widget=true&amp;headers=false&gid=430647412"
