...
const BusinessIdeas = () => {
    document.title = "Business Ideas | 3D ACTIO";
        ...
        <div className="page-content" style={{ paddingTop: '-10px' }}>
            <Container fluid>
                ...
                <div style={{ position: 'relative', width: '100%', height: 'calc(127vh - 50px)', overflow: 'hidden' }}>
                    <iframe
                        src="https://docs.google.com/spreadsheets/d/1adAuB3RqxekvZphqqHspS0aHvKCffFSAQCm-h9wCgUs/edit?usp=sharing/pubhtml?gid=822064063&amp;single=true&amp;widget=true&amp;headers=false&gid=653123435"
                        style={{ width: '100%', height: '100%', border: 'none', marginTop: '-135px' }}
                    ></iframe>
                    <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '30px', backgroundColor: 'white' }}></div>
                    <div style={{ position: 'absolute', top: 0, left: 0, bottom: 0, width: '45px', backgroundColor: 'white' }}></div>
                </div>
            </Container>
        </div>
    );
