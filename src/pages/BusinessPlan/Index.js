...
const BusinessPlan = () => {
    document.title = "Business Plan | 3D ACTIO";
        ...
        <div className="page-content" style={{ paddingTop: '25px' }}>
            <Container fluid>
                ...
                <div style={{ position: 'relative', width: '100%', height: 'calc(155vh - 50px)', overflow: 'hidden' }}>
                    <iframe
                        src="https://docs.google.com/spreadsheets/d/1adAuB3RqxekvZphqqHspS0aHvKCffFSAQCm-h9wCgUs/edit?usp=sharing/pubhtml?gid=822064063&amp;single=true&amp;widget=true&amp;headers=false&gid=150723293"
