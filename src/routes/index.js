...
import DevelopCompanyDNA from '../pages/DevelopCompanyDNA/Index';
import CompanyProfile from "../pages/CompanyProfile/Index";
import BusinessIdeas from "../pages/BusinessIdeas/Index";
import CompanyDNA from "../pages/CompanyDNA/Index";
import IndustryAnalysis from "../pages/IndustryAnalysis/Index";
import PESTLEAnalysis from "../pages/PESTLEAnalysis/Index";
import SWOTAnalysis from "../pages/SWOTAnalysis/Index";
import BusinessStrategy from "../pages/BusinessStrategy/Index";
import StrategyMatrix from "../pages/StrategyMatrix/Index";
import Summary from "../pages/Summary/Index";
import BusinessModelCanvas from "../pages/BusinessModelCanvas/Index";
import KRIs from "../pages/KRIs/Index";
import BusinessPlan from "../pages/BusinessPlan/Index";
import InvestorPack from "pages/InvestorPack/Index";
...
const authProtectedRoutes = [
  ...
  { path: "/develop-company-dna", component: <DevelopCompanyDNA /> },
  { path: "/company-profile", component: <CompanyProfile /> },
  { path: "/business-ideas", component: <BusinessIdeas /> },
  { path: "/company-dna", component: <CompanyDNA /> },
  { path: "/industry-analysis", component: <IndustryAnalysis /> },
  { path: "/pestle-analysis", component: <PESTLEAnalysis /> },
  { path: "/swot-analysis", component: <SWOTAnalysis /> },
  { path: "/business-strategy", component: <BusinessStrategy /> },
  { path: "/strategy-matrix", component: <StrategyMatrix /> },
  { path: "/summary", component: <Summary /> },
  { path: "/business-model-canvas", component: <BusinessModelCanvas /> },
  { path: "/cash-flow", component: <CashFlow /> },
  { path: "/kris", component: <KRIs /> },
  { path: "/business-plan", component: <BusinessPlan /> },
  { path: "/investor-pack", component: <InvestorPack /> },
